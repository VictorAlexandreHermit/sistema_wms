-- Migration Inicial: Criação das 13 tabelas principais do WMS Agiliza
...
CREATE TABLE IF NOT EXISTS divergencias_recebimento (
    id INT AUTO_INCREMENT PRIMARY KEY,
    pedido_id INT NOT NULL,
    produto_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS logs_auditoria_estoque (
    id INT AUTO_INCREMENT PRIMARY KEY,
    produto_id INT NOT NULL,
    endereco_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS pesquisas_otif (
    id INT AUTO_INCREMENT PRIMARY KEY,
